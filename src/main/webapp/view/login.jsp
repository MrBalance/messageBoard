...
<script type="text/javascript">
    ...
    function login(){
        var account = $("input[name='login']").val();
        ...
        <div region="center" border="false" style="padding:5px;background:#fff;border:1px solid #ccc;">
            <form id="loginForm" method="post">
                <div style="padding:5px 0;">
                    ...
                    <input class="easyui-textbox" type="text" name="login" data-options="iconCls:'icon-man'" value="admin" style="width:260px;"/>
                </div>
                <div style="padding:5px 0;">
                    <label for="password">密码:</label>
                    <input class="easyui-textbox" type="password"  name="password" data-options="iconCls:'icon-lock'" value="123456" style="width:260px;"/>
                </div>
